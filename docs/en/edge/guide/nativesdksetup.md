...
If these libraries wouldn't be installed on the device automatically - you should use the following commands (in the terminal, connected to your device in the developer mode):
  :::term
  devel-su
  pkcon refresh
  pkcon update
