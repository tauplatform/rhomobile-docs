section 'rhodescommonapi-reference', 'API Reference', 'Mobile API Docs' do
  ...
  topic 'en/edge/api/DeviceSecurity', 'DeviceSecurity'
...
section 'rhomob-apps', 'Developing Apps', 'Mobile Guides' do
  ...
  topic 'en/edge/guide/build_sailfish', 'Build for Sailfish'
  topic 'en/edge/guide/build_wm', 'Build for Windows Mobile'
  topic 'en/edge/guide/build_uwp', 'Build for Windows 10(UWP)'
...
section 'getting-started', 'Introduction', 'RhoMobile Tutorials' do
  topic 'en/edge/tutorial/welcome', 'Welcome to RhoMobile Tutorials'
  topic 'en/edge/tutorial/emberjs', 'Emberjs'
  topic 'en/edge/tutorial/rhoconnect-tutorial', 'RhoConnect'
end
