...
<a name='phomeKeyValue'></a><div class=' method  js ruby' id='phomeKeyValue'><div class="signature d-flex"><div class="name">homeKeyValue</div><div class='return-values'> : <span class='text-info'>STRING</span>  </div></div><ul class="nav nav-tabs"><li class='nav-item'><a class="nav-link active" href="#phomeKeyValue1" data-toggle="tab">Description</a></li><li  class='nav-item'><a  class="nav-link" href="#phomeKeyValue2" data-toggle="tab">Params</a></li><li class='nav-item'><a class="nav-link" href="#phomeKeyValue6" data-toggle="tab">Access</a></li></ul><div class='tab-content border border-top-0 p-3 mb-3' id='tc-homeKeyValue'><div class="tab-pane fade active show" id="phomeKeyValue1"><p>Specifies a key which, when pressed, will navigate to the start page as defined in the application configuration. Set to &lsquo;Disabled&rsquo; to prevent this behavior.</p>
...
</dd><a name='c2'></a><dt>ALL_KEYS</dt><dd><p>all keys captured</p>
</dd></dl></div>
<a name='Examples'></a>
<h2>Examples</h2>
...
<p>The following example will navigate to the application start page when return is pressed.</p>
...
<li>On ET1, Search (P3) key is application specific. Dispatching this key within the application won't do anything as it the application doesn&rsquo;t do anything specific with this key (unlike the menu key which raises the menu).
