...
Below is a list of the new common APIs for RhoMobile Suite 7.4, which are recommended for all new projects. If you're moving a app built with previous version of Rhodes to 7.4, please consult the [7.x migration guide](apiusage). 
